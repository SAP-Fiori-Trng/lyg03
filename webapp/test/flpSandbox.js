		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#dwfioritrnglyg03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dwfioritrnglyg03-display": {
								"semanticObject": "dwfioritrnglyg03",
								"action": "display",
								"description": "An SAP Fiori application for Products Management.",
								"title": "Products Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dw.fiori.trng.lyg03",
									"url": sap.ui.require.toUrl("dw/fiori/trng/lyg03")
								}
							}
						}
					}
